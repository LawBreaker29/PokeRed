/**
 * @author LawBreaker29
 * @date 2022-23-22 version 0.2
 * @description Image delay loading, split image replacement, image error escalation processing

5

* @update Increase non-visual area delay loading
 * @example $(".container").lazy(options);
 *          Traverse$(".container")Lazyload is applied to img nodes in nodes; if this node is an img node, only this node is applied.
 *          options.srcSign {String} It can be empty.imgNode-contractedsrcLogo, default tolazy-src；AnswerimgThe node is：<img lazy-src="img/hello.jpg" />
 *          options.errCallBack {Function} 可为空.提供img加载失败回调，供业务额外去处理加载失败逻辑
 *          options.container {Dom} Provide the loading capacity of the visible area in the container node, which defaults towindow
 */
